<x-app-layout>
    ...
    <div class="py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div class="lg:max-w-[1440px] md:max-w-[744px] max-w-[375px] mx-auto bg-white lg:px-10 md:px-6 px-4 py-12 rounded-lg shadow-xl">
            <div class="md:flex justify-center items-center gap-8 relative">
                <div>
                    <div class="relative">
                        ...
                        {{-- <img src="{{ Storage::url($curso->image->url) }}" alt="Imagen del Curso"
                            ...
                            <img src="https://d11cuk1a0j5b57.cloudfront.net/blog/wp-content/uploads/2022/08/18125803/Mejores-plataformas-de-cursos.jpg" alt="Imagen del Curso"
                            class="lg:block md:hidden block rounded-lg shadow-lg object-cover" style=" height: 300px;">
                        <!-- Categorías -->
                        <div class="absolute top-0 right-0 mr-4 mt-4">
                            <div class="categorias">
                                <span class="inline-block bg-yellow-400 text-gray-800 px-3 py-1 font-bold rounded-full text-xs">{{ $curso->category->nombre }}</span>
                            </div>
                        </div>
                    </div>
                    <img src="{{ Storage::url($curso->image->url) }}" alt="Imagen del Curso"
                ...
                <div>
                    <!-- Contenido del curso -->
                    <h2 class="lg:text-4xl md:text-3xl text-3xl font-semibold md:text-left text-center text-gray-600">{{ $curso->nombre }}</h2>
    ...
    <div class="mx-auto px-4 py-12 relative bg-gradient-to-r bg-slate-300">
        ...
        <div class="flex flex-col items-center justify-center">
            <div class="relative flex flex-col sm:flex-row w-full max-w-[48rem] rounded-xl bg-white shadow-md overflow-hidden">
                <div class="w-full sm:w-1/3 bg-gradient-to-r flex justify-center items-center">
                    <img src="https://cdn-icons-png.flaticon.com/512/3135/3135768.png" alt="Foto del docente" class="object-cover h-64 w-full sm:h-full rounded-tl-xl sm:rounded-tl-none sm:rounded-l-xl">
                </div>
                <div class="p-6 w-full sm:w-2/3">
                    ...
                    <h4 class="mb-3 text-2xl font-semibold text-gray-800">{{ $curso->user->name . " " . $curso->user->profile->apellidos}}</h4>
