<div>
    <h1 class="text-center text-3xl mt-10 text-gray-700 mb-6">ULTIMOS CURSOS</h1>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8  ">
        <div class="form-group">
            <div class="flex flex-wrap">
                <div class="w-full md:w-1/3 px-2 mb-4 md:mb-0">
                    <input wire:model.live="search" type="text" class="form-input rounded w-full"
                ...
                <div class="w-full md:w-1/3 px-2">
                    <select wire:model.live="level_id" class="form-select w-full rounded">
                        <option value="">Selecione el Nivel</option>
            ...
            <nav class="flex justify-between items-center" aria-label="Pagination">
                ...
                <ul class="flex justify-end space-x-2">
                    ...
                    @if ($cursos->onFirstPage())
                        <li class="relative inline-flex items-center px-2 py-1 rounded-md border border-gray-300 bg-white text-sm font-medium text-gray-400">
                            <span>&laquo; Anterior</span>
                        </li>
                    @else
                        <li>
                            <a href="{{ $cursos->previousPageUrl() }}" class="relative inline-flex items-center px-2 py-1 rounded-md border border-gray-300 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50">
                                <span>&laquo; Anterior</span>
                            </a>
                        </li>
                    @endif
                    ...
                    @if ($cursos->hasMorePages())
                        <li>
                            <a href="{{ $cursos->nextPageUrl() }}" class="relative inline-flex items-center px-2 py-1 rounded-md border border-gray-300 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50">
