...
@section('content')
    ...
    <div class="container py-8">
        <div class="card">
            <div class="card-body">
                <h3 class="text-2xl font-bold">CREAR NUEVO EXAMEN</h3>
                <hr class="mt-2 mb-6">
                {!! Form::open(['route' => 'admin.examenes.store', 'autocomplete' => 'off', 'files' => true]) !!}
                @include('admin.examenes.partials.form')
                {!! Form::submit('Crar Examen', ['class' => 'btn btn-primary mt-2']) !!}
                {!! Form::close() !!}
            </div>
        </div>
    </div>
